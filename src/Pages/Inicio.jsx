...
const HomePage = () => {
  return (
    <div style={{ textAlign: 'center', padding: '20px' }}>
      <img src="/public/assets/logoWilSmart.jpg" alt="Imagen de bienvenida" style={{ width: '80px' }} />
      <Title level={4}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Link to="/sistema-ventas">
          <Card title="Sistema de Ventas" style={{ width: 300, marginLeft: '120px', backgroundColor: '#f0f0f0' }}>
            <img src="/public/assets/logoVentas.png" alt="Ventas" style={{ width: '250px' }} />
            <Paragraph>
        ...
        <Link to="/sistema-administración">
          <Card title="Sistema de Administración" style={{ width: 300, backgroundColor: '#f0f0f0' }}>
            <img src="/public/assets/logoAdministracion.png" alt="Administración" style={{ width: '250px' }} />
            <Paragraph>
        ...
        <Link to="/sistema-servicios">
          <Card title="Sistema de Servicios" style={{ width: 300, marginRight: '120px', backgroundColor: '#f0f0f0' }}>
            <img src="/public/assets/logoServicios.png" alt="Servicios" style={{ width: '200px' }} />
            <Paragraph>
